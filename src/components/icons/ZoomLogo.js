...
function ZoomLogo({ className, fill }) {
  return (
...
<g>
	<path fill='#2D8CFF'  d="M224.3,91.7c-7.8-7.8-18-11.7-28.3-11.7H196c-10.2,0-20.5,3.9-28.3,11.7c-15.6,15.6-15.6,40.9,0,56.6
	...
	<path fill='#2D8CFF'  d="M308.3,91.7c-7.8-7.8-18-11.7-28.3-11.7c-10.2,0-20.5,3.9-28.3,11.7c-15.6,15.6-15.6,40.9,0,56.6
	...
	<path fill='#2D8CFF'  d="M96,159.8l4,0.2h60l-0.2-4c-0.5-6.6-5.2-11.4-11.8-11.8l-4-0.2h-36l48-48l-0.2-4c-0.3-6.6-5.2-11.5-11.8-11.8
		l-4-0.2l-60,0l0.2,4c0.5,6.5,5.3,11.4,11.8,11.8l4,0.2h36l-48,48l0.2,4C84.6,154.6,89.4,159.4,96,159.8z"/>
	<path fill='#2D8CFF'  d="M369.8,104c1.4,2.4,1.8,5,2,8l0.2,4v28l0.2,4c0.4,6.5,5.2,11.4,11.8,11.8l4,0.2v-44l0.2-4c0.2-3,0.6-5.7,2-8.1
