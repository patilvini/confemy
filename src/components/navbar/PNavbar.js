    ...
    <div className="navbar-responsive">
      ...
      {menu && (
        <div className="nav-menu">
          <Link onClick={()=>{setMenuOpen(false)}} to="search-conference">
          ...
          {isAuthenticated && user ? (
            <>
              <div className="nav-item">
                ...
                {
                  cart && <div className="cart-container"><BookingCart closeNav={()=>setMenuOpen(false)} className="cart-small" /></div> 
                }
              ...
              <div className="nav-item">
                ...
                <AuthDropdown  closeNav={()=>setMenuOpen(false)} className="auth-dropdown-small" />
