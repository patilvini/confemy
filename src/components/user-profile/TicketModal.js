    ...
    return(
        ...
        <Modal onDismiss={onDismiss }>
               ...
               <div className="ticket-details">
                 <RedirectIcon style={{}}/> <span style={{fontSize: "2rem", margin:"0 0 0rem .5rem", color: "#55A0FA"}}>Preview</span> 
                     ...
                     Registration no. {data.registrationNumber} on {DateTime.fromISO(data.bookingDate).toLocaleString({
                ...
                return (
                  <span style={{ marginRight: "1rem" }} key={index}>
                    {item.creditType} {item.quantity}
                     ...
                     <h3 style={{marginTop: "1rem"}}> Guest1 </h3>
