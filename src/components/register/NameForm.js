  ...
  return (
    <Fragment>
      ...
      <div className='input-container position-relative'>
        ...
        <DropdownIcon className=' input-icon-location large-icon' />
      </div>
      ...
      <div>
        <div className='position-relative input-container'>
          ...
          <i
            ...
            className={showPassword ? 'display-none' : 'input-icon-location'}
          >
          ...
          <i
            onClick={togglePassword}
            className={showPassword ? 'input-icon-location' : 'display-none'}
          >
        ...
        <div className='position-relative input-container'>
          ...
          <i
            ...
            className={
              showConfirmPassword ? 'display-none' : 'input-icon-location'
            }
          >
            <ClosedEyeIcon className='large-icon' />
          </i>
          ...
          <i
            onClick={toggleConfirmPassword}
            className={
              showConfirmPassword ? 'input-icon-location' : 'display-none'
            }
          >
            <OpenEyeIcon className='large-icon' />
          </i>
