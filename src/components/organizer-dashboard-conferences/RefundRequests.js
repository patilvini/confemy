...
<div>
  ...
  <div className="request-table-heading">
    ...
    <div className="request-table-item"> <button className="button button-green">Approve all</button></div>
  ...
  {a.map((item, index)=> {
    ...
    <div className="request-table-item"><p style={{fontSize:"1.7rem"}} className="caption-2-regular-gray3">OCT 21, 2021</p></div>

    <div className="request-table-item"><p className="caption-2-regular-gray3">2164516123168</p></div>
    <div className="request-table-item"> <button className="button button-green">Approve Refund</button></div>
