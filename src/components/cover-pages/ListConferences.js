    ...
    <div>
      <div className="cover-grid">
        <div className="section-one">
          ...
          >
           Confemy is a new age platform for hosting medical conferences, in few easy steps.
          </p>
          <button className="button button-green">HOST YOUR CONFERENCE</button>
        </div>
        <div>
      ...
      <div style={{ backgroundColor: "#ecf0f2" }} className="cover-grid">
        <div className="section-two">
          <h1 >Easy Setup</h1>
          <p
            style={{ margin: "2.4rem 0 3.2rem 0", width: "30.9rem", lineHeight:"2.4rem" }}
            className="caption-2-regular-gray3"
          >
      ...
      <div className="getStarted">
        ...
        <button className="button button-primary">HOST YOUR CONFERENCE</button>
